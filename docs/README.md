...
| [백엔드 컨벤션](backend-convention.md) | Kotlin·Spring 구현 및 리뷰 규칙 |
...
- 백엔드: [백엔드 컨벤션](backend-convention.md), [기술 아키텍처](architecture.md)
- 요구사항 변경: [OpenSpec 인덱스](../openspec/README.md), [Git 전략](git-strategy.md)

## 작업 기록과 아카이브

- 현재 P0 실행 계획: [문서·개발 운영 정리 구현 계획](superpowers/plans/2026-07-18-documentation-operations.md)
