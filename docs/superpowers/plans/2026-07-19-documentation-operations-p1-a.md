...
- [ ] **Step 1: 기준선을 다시 확인하고 작업 브랜치를 만든다.**
...
- [ ] **Step 1: 원본을 보존한 채 대상 문서의 섹션 경계를 확인한다.**
...
- [ ] **Step 2: README와 두 역할 문서를 작성하고 원본 파일을 제거한다.**
...
- [ ] **Step 3: RED가 의도한 이유로 실패했는지 확인한 뒤 GREEN을 확인한다.**
...
- [ ] **Step 1: 새 문서 검사와 OpenSpec·pre-push 검사를 실행한다.**
