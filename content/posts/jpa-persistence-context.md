...
![](/images/posts/jpa-persistence-context/8a8afe57_image.png)

엔티티매니저가 내부에 존재하고 이를 사용하는 것을 볼 수 있어요.  
![](/images/posts/jpa-persistence-context/2e519081_image.png)  
...
생명 주기를 나타낸 그림이에요.
![엔티티의 생명 주기, 김영한님 자료](/images/posts/jpa-persistence-context/2cda8228_image.png)
...
```
![비영속](/images/posts/jpa-persistence-context/390f94f6_image.png)
...
em.persist(user);
```
![](/images/posts/jpa-persistence-context/ddf0e960_image.png)
...
![](/images/posts/jpa-persistence-context/88a9051b_image.png)
...
![](/images/posts/jpa-persistence-context/8ab441cd_image.png)

![](/images/posts/jpa-persistence-context/a0cb1d40_image.png)
...
![](/images/posts/jpa-persistence-context/789c9d4a_image.png)

![](/images/posts/jpa-persistence-context/b0dc794a_image.png)
...
![등록](/images/posts/jpa-persistence-context/b0d68260_image.png)

### 엔티티 수정
JPA는 수정을 위한 메소드가 아닌 변경 감지(Dirty Checking) 기능을 제공해요.
변경 감지 기능은 엔티티의 변경 사항을 데이터베이스에 자동으로 반영하는 기능이에요.

![수정](/images/posts/jpa-persistence-context/fde6a331_image.png)
...
![](/images/posts/jpa-persistence-context/6ad14548_image.png) save() 메소드 내에서 flush() 메소드를 명시적으로 호출하는 것이 아니라
